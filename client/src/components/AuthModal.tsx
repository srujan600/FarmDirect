        ...
        <div className="p-5">
          {step === 'input' ? (
            <div>
              ...
              {/* 3. GOOGLE OAUTH SIGN IN BUTTON */}
              <div className="relative my-4 text-center">
                <div className="absolute inset-0 flex items-center">
                  <div className="w-full border-t border-outline-variant"></div>
                </div>
                <span className="relative px-3 bg-surface-container-lowest text-[11px] font-semibold text-on-surface-variant uppercase tracking-wider">
                  Or continue with
                </span>
              </div>
              ...
              <button
                ...
                disabled={isLoading}
                className="w-full min-h-[44px] px-4 py-2.5 rounded-xl border border-outline-variant bg-surface-container-low hover:bg-surface-container text-on-surface font-bold text-sm shadow-sm transition-all active:scale-[0.99] flex items-center justify-center gap-2.5 cursor-pointer disabled:opacity-50"
              >
