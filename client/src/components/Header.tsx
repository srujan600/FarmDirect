  ...
  return (
    <>
      ...
      <header className="bg-surface-container-lowest border-b border-outline-variant shadow-elevation-1 sticky top-0 z-40 transition-all w-full">
        <nav className="flex items-center justify-between w-full px-2 sm:px-gutter md:px-margin-lg max-w-7xl mx-auto h-16 min-w-0 gap-1 sm:gap-3">
          ...
          <div className="flex items-center gap-2 sm:gap-3 shrink-0 min-w-0">
            ...
            <div className="hidden xl:flex items-center gap-1.5 ml-4 px-2.5 py-1 rounded-full bg-surface-container text-secondary text-label-sm font-label-sm border border-outline-variant shrink-0">
          ...
          <div className="hidden md:flex items-center gap-5 lg:gap-8 shrink-0">
            <a
              className="text-secondary font-label-lg font-bold pb-1 border-b-2 border-secondary transition-colors"
              href="#marketplace"
            >
              {t('marketplace', language)}
            </a>
            <a
              className="text-on-surface-variant font-label-md hover:text-on-surface pb-1 transition-colors"
          ...
          <div className="flex items-center gap-1.5 sm:gap-2 shrink-0">
            ...
            <select
              ...
              className="min-h-[44px] px-2 sm:px-2.5 py-2 rounded-xl border border-outline-variant bg-surface-container-lowest text-on-surface text-label-sm font-label-sm font-semibold focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-primary select-none cursor-pointer shrink-0 max-w-[105px] xs:max-w-none transition-all shadow-sm"
            ...
            <button
              ...
              className="inline-flex items-center justify-center gap-1.5 min-h-[44px] px-2 sm:px-3 py-2 rounded-xl border border-secondary/40 bg-secondary/10 hover:bg-secondary/20 text-label-sm font-label-sm text-primary transition-all shadow-sm active:scale-[0.98] focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-secondary shrink-0 select-none cursor-pointer"
              type="button"
            ...
            >
              ...
              <span className="font-bold text-on-surface hidden xs:inline text-xs">
            ...
            <button
              ...
              className="w-11 h-11 min-w-[44px] min-h-[44px] flex items-center justify-center rounded-xl text-on-surface-variant hover:bg-surface-container-low active:scale-95 transition-all focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-primary shrink-0 select-none cursor-pointer"
            ...
            <button
              onClick={onOpenCart}
              className="w-11 h-11 min-w-[44px] min-h-[44px] flex items-center justify-center rounded-xl text-on-surface-variant hover:bg-surface-container-low relative active:scale-95 transition-all focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-primary shrink-0 select-none cursor-pointer"
              title="View Cart"
              type="button"
            >
              <span className="material-symbols-outlined text-[20px]">shopping_cart</span>
              {cart.length > 0 && (
                <span className="absolute top-1 right-1 w-4 h-4 bg-tertiary-container text-surface-container-lowest rounded-full text-[10px] font-bold flex items-center justify-center ring-2 ring-surface-container-lowest">
                  {cart.length}
                </span>
              )}
            </button>
            ...
            <button
              ...
              className="hidden lg:inline-flex items-center justify-center gap-1.5 min-h-[44px] sm:min-h-[48px] px-4 py-2 rounded-xl bg-tertiary-container hover:bg-on-tertiary-fixed-variant text-surface-container-lowest font-label-sm font-bold shadow-sm transition-all active:scale-[0.98] focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-tertiary-container shrink-0 select-none cursor-pointer"
            >
              <span className="material-symbols-outlined text-[18px]">agriculture</span>
              <span>{t('sellHarvest', language)}</span>
            </button>

            {/* User Auth Status / Trigger */}
            {isAuthenticated ? (
              <div className="flex items-center gap-1.5 pl-1 pr-2 py-1 rounded-xl bg-surface-container border border-outline-variant text-xs shadow-sm">
              ...
              <button
                onClick={onOpenAuth}
                type="button"
                className="inline-flex items-center justify-center gap-1.5 min-h-[44px] px-3 py-2 rounded-xl bg-primary hover:bg-primary-container text-on-primary font-label-sm font-bold shadow-sm transition-all active:scale-[0.98] focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-primary shrink-0 text-xs select-none cursor-pointer"
            ...
            <a
              href="#portal-sandbox"
              className="hidden xl:inline-flex items-center justify-center gap-1.5 min-h-[44px] px-3 py-2 rounded-xl bg-surface-container-high hover:bg-surface-container-highest text-on-surface font-label-sm font-bold shadow-sm transition-all active:scale-[0.98] focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-primary shrink-0 text-xs select-none"
            >
              <span>Portals</span>
